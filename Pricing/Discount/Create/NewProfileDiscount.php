...
class NewProfileDiscount extends NewDiscount
{
    protected EntityManager $em;

    public function create(AxAccountdetails $account): AxAdjustments
    {
        ...
        foreach ($this->discountType as $type) {
            switch ((int) $type) {
                ...
                case DiscountTypes::RENEWAL:
                    ...
                    break;
                case DiscountTypes::SIGNUP:
                    $discount->setIsnewsignup(true);
                    break;
                default:
